...
- Update PHPStan to version 2 and remove redundant runtime type checks identified by its stricter analysis.
- Add shared `AGENTS.md` guidance for coordinating multiple AI coding assistants.
